...
declare const Loopback4GithubAppApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class Loopback4GithubAppApplication extends Loopback4GithubAppApplication_base {
